...
const CATALOG = [
  ...
  { id: 'sig',        name: 'Signal',           base: 'SFGPUUS----', cat: 'F' },
  { id: 'intel',      name: 'Intelligence',     base: 'SFGPUMI----', cat: 'F' },
  { id: 'med',        name: 'Medical',          base: 'SFGPUMF----', cat: 'F' },
...
const GRAPHIC_CATALOG = [
  ...
  { id: 'loa',          name: 'Limit of Advance',     type: 'line', color: '#cc2200', dash: '6,4',   weight: 2.5, label: 'LOA',  cat: 'LN' },
  { id: 'fscl',         name: 'Fire Spt Coord Line',  type: 'line', color: '#ff6600', dash: '10,4',  weight: 2,   label: 'FSCL', cat: 'LN' },
  { id: 'cfl',          name: 'Coord Fire Line',      type: 'line', color: '#e08800', dash: '8,4',   weight: 2,   label: 'CFL',  cat: 'LN' },
  ...
  { id: 'atk-pos',      name: 'Attack Position',      type: 'area', color: '#0055cc', fill: 0.08, weight: 2, dash: '4,4', label: 'ATCP',  cat: 'AR' },
  { id: 'sbf',          name: 'Support by Fire',      type: 'area', color: '#1a7acc', fill: 0.10, weight: 2, dash: null,  label: 'SBF',   cat: 'AR' },
