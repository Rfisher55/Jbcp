...
const CATALOG = [
  ...
  { id: 'airborne',   name: 'Airborne',         base: 'SFGPUCII---', cat: 'F' },
  { id: 'airasslt',   name: 'Air Assault',      base: 'SFGPUCIB---', cat: 'F' },
  { id: 'sf',         name: 'Special Forces',   base: 'SFGPUUIS---', cat: 'F' },
  { id: 'ranger',     name: 'Ranger',           base: 'SFGPUCIR---', cat: 'F' },
  { id: 'at',         name: 'Anti-Tank',        base: 'SFGPUCAT---', cat: 'F' },
  { id: 'cbrn',       name: 'CBRN',             base: 'SFGPUCWM---', cat: 'F' },
